...
impl TreeBuilder {
    pub fn clear(&mut self) {
        self.applied.clear();
        self.working.clear();
        // Avoid 0 pointers, and reserve space for start index.
        // Note that we could store say LE u64 here instead, which saves two
        // bytes, but that's not a huge amortized win, and this keeps all ints
