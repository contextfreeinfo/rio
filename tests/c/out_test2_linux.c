...
const TypeInfo *typeinfo_table[180] = {
  ...
  [169] = NULL, // Function
  [170] = &(TypeInfo){TYPE_REF, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(10, TYPE_LONG, long)},
  [171] = NULL, // Function
  [172] = NULL, // No associated type
  [173] = NULL, // No associated type
  [174] = NULL, // Function
  [175] = &(TypeInfo){TYPE_CONST, .size = sizeof(long const ), .align = alignof(long const ), .base = TYPEID(10, TYPE_LONG, long)},
  [176] = &(TypeInfo){TYPE_REF, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(175, TYPE_CONST, long const )},
  [177] = NULL, // Function
  [178] = NULL, // Function
  [179] = NULL, // Function
};
