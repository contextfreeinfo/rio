...
const TypeInfo *typeinfo_table[184] = {
  ...
  [173] = NULL, // Function
  [174] = &(TypeInfo){TypeKind_Ref, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(10, TypeKind_Long, long)},
  [175] = NULL, // Function
  [176] = NULL, // No associated type
  [177] = NULL, // No associated type
  [178] = NULL, // Function
  [179] = &(TypeInfo){TypeKind_Const, .size = sizeof(long const ), .align = alignof(long const ), .base = TYPEID(10, TypeKind_Long, long)},
  [180] = &(TypeInfo){TypeKind_Ref, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(179, TypeKind_Const, long const )},
  [181] = NULL, // Function
  [182] = NULL, // Function
  [183] = NULL, // Function
};
