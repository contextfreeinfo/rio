...
const TypeInfo *typeinfo_table[183] = {
  ...
  [172] = NULL, // Function
  [173] = &(TypeInfo){TypeKind_Ref, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(12, TypeKind_LLong, llong)},
  [174] = NULL, // Function
  [175] = NULL, // No associated type
  [176] = NULL, // No associated type
  [177] = NULL, // Function
  [178] = &(TypeInfo){TypeKind_Const, .size = sizeof(llong const ), .align = alignof(llong const ), .base = TYPEID(12, TypeKind_LLong, llong)},
  [179] = &(TypeInfo){TypeKind_Ref, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(178, TypeKind_Const, llong const )},
  [180] = NULL, // Function
  [181] = NULL, // Function
  [182] = NULL, // Function
};
