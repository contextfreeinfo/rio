...
const TypeInfo *typeinfo_table[302] = {
  ...
  [167] = NULL, // Function
  [168] = NULL, // Function
  [169] = &(TypeInfo){TypeKind_Array, .size = sizeof(int [11]), .align = alignof(int [11]), .base = TYPEID(8, TypeKind_Int, int), .count = 11},
  [170] = NULL, // Function
  [171] = NULL, // Function
  ...
  [192] = NULL, // Function
  [193] = NULL, // Function
  [194] = &(TypeInfo){TypeKind_Ptr, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(15, TypeKind_Double, double)},
  [195] = NULL, // Function
  [196] = NULL, // Function
  [197] = NULL, // Function
  [198] = NULL, // Function
  ...
  [264] = NULL, // Function
  [265] = NULL, // Function
  [266] = &(TypeInfo){TypeKind_Ptr, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(6, TypeKind_Short, short)},
  [267] = NULL, // Function
  [268] = NULL, // Function
  [269] = NULL, // Function
  [270] = &(TypeInfo){TypeKind_Const, .size = sizeof(short const ), .align = alignof(short const ), .base = TYPEID(6, TypeKind_Short, short)},
  [271] = &(TypeInfo){TypeKind_Ptr, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(270, TypeKind_Const, short const )},
  [272] = NULL, // Function
  [273] = NULL, // Function
  [274] = NULL, // Function
  [275] = NULL, // Function
  ...
  [293] = NULL, // Function
  [294] = &(TypeInfo){TypeKind_Const, .size = sizeof(long const ), .align = alignof(long const ), .base = TYPEID(10, TypeKind_Long, long)},
  [295] = &(TypeInfo){TypeKind_Ref, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(294, TypeKind_Const, long const )},
  [296] = NULL, // Function
  [297] = NULL, // Function
  [298] = NULL, // Function
  [299] = &(TypeInfo){TypeKind_Array, .size = sizeof(int [9]), .align = alignof(int [9]), .base = TYPEID(8, TypeKind_Int, int), .count = 9},
  [300] = NULL, // No associated type
  [301] = &(TypeInfo){TypeKind_Array, .size = sizeof(char [15]), .align = alignof(char [15]), .base = TYPEID(3, TypeKind_Char, char), .count = 15},
};

int num_typeinfos = 302;
