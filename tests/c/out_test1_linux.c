...
const TypeInfo *typeinfo_table[272] = {
  ...
  [264] = NULL, // Function
  [265] = &(TypeInfo){TypeKind_Const, .size = sizeof(long const ), .align = alignof(long const ), .base = TYPEID(10, TypeKind_Long, long)},
  [266] = &(TypeInfo){TypeKind_Ref, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(265, TypeKind_Const, long const )},
  [267] = NULL, // Function
  [268] = NULL, // Function
  [269] = NULL, // Function
