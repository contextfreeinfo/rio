...
const TypeInfo *typeinfo_table[267] = {
  ...
  [91] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(uint [3]), .align = alignof(uint [3]), .base = TYPEID(9, TYPE_UINT, uint), .count = 3},
  [92] = NULL, // Function
  [93] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(9, TYPE_UINT, uint)},
