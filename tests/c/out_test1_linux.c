...
const TypeInfo *typeinfo_table[299] = {
  ...
  [290] = NULL, // Function
  [291] = &(TypeInfo){TypeKind_Const, .size = sizeof(long const ), .align = alignof(long const ), .base = TYPEID(10, TypeKind_Long, long)},
  [292] = &(TypeInfo){TypeKind_Ref, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(291, TypeKind_Const, long const )},
  [293] = NULL, // Function
  [294] = NULL, // Function
  [295] = NULL, // Function
