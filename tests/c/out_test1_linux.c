...
const TypeInfo *typeinfo_table[292] = {
  ...
  [283] = NULL, // Function
  [284] = &(TypeInfo){TypeKind_Const, .size = sizeof(long const ), .align = alignof(long const ), .base = TYPEID(10, TypeKind_Long, long)},
  [285] = &(TypeInfo){TypeKind_Ref, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(284, TypeKind_Const, long const )},
  [286] = NULL, // Function
  [287] = NULL, // Function
  [288] = NULL, // Function
