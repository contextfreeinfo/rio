...
int main() {
  ...
  sample2_show_prices((rio_Span_sample2_Person){(sample2_Person[3]){(sample2_Person){.age = age, .name = name}, (sample2_Person){.name = "Bernie", .age = 9}, (sample2_Person){.name = "Clara", .age = 68}}, 3});
}
