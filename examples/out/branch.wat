(module
  ...
  (func $describe (;9;) (type 11) (param i32)
    local.get 0
    call $description
    call $core::print
  )
  (func $description (;10;) (type 14) (param i32) (result i32 i32)
    (local i32 i32)
    local.get 0
    i32.const 0
    i32.lt_s
    if (type 9) (result i32 i32) ;; label = @1
      ...
      i32.const 0
      i32.gt_s
      if (type 9) (result i32 i32) ;; label = @2
        i32.const 8
        i32.const 4107
      else
        i32.const 4
  ...
  (func $less (;11;) (type 13) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    i32.lt_s
  )
